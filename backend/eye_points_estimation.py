...
FACE_DET_MODEL_PATH = 'backend/data/models/blazeface.opt.onnx.prototxt'
FACE_DET_WEIGHT_PATH = 'backend/data/models/blazeface.opt.onnx'
FACE_LM_MODEL_PATH = 'backend/data/models/facemesh.opt.onnx.prototxt'
FACE_LM_WEIGHT_PATH = 'backend/data/models/facemesh.opt.onnx'
IRIS_LM_MODEL_PATH = 'backend/data/models/iris.opt.onnx.prototxt'
IRIS_LM_WEIGHT_PATH = 'backend/data/models/iris.opt.onnx'
HEAD_POSE_MODEL_PATH = 'backend/data/models/hopenet_robust_alpha1.opt.onnx.prototxt'
